        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerUserId = table.Column<int>(type: "integer", nullable: false),
                    AllowCustomerTicketCreation = table.Column<bool>(type: "boolean", nullable: false),
                    RequireApprovalForClose = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Description = table.Column<string>(type: "text", nullable: true),
                    DefaultProjectCategoryId = table.Column<int>(type: "integer", nullable: true),
                    DefaultIconKey = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    DefaultAllowCustomerTicketCreation = table.Column<bool>(type: "boolean", nullable: false),
                    DefaultRequireApprovalForClose = table.Column<bool>(type: "boolean", nullable: false),
                    Timeline = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectTemplates_ProjectCategories_DefaultProjectCategoryId",
                        column: x => x.DefaultProjectCategoryId,
                        principalTable: "ProjectCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeamMembers_Agents_AgentId",
                        column: x => x.AgentId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectMembers_Agents_AgentId",
                        column: x => x.AgentId,
                        principalTable: "Agents",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MeetingAttendees_Agents_AgentId",
                        column: x => x.AgentId,
                        principalTable: "Agents",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartedAt = table.Column<DateTime>(type: "timestamp with time zone", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TimeEntries_Agents_AgentId",
                        column: x => x.AgentId,
                        principalTable: "Agents",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MeetingAttendees_AgentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectMembers_AgentId",
                table: "ProjectMembers",
                column: "AgentId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectMembers_ProjectId_AgentId",
                table: "ProjectMembers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTemplates_DefaultProjectCategoryId",
                table: "ProjectTemplates",
                column: "DefaultProjectCategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamMembers_AgentId",
                table: "TeamMembers",
                column: "AgentId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamMembers_TeamId_AgentId",
                table: "TeamMembers",
                columns: new[] { "TeamId", "AgentId" },
                unique: true,
                filter: "\"AgentId\" IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPermissions_ApplicationUserId_PermissionId",
                table: "UserPermissions",
                columns: new[] { "ApplicationUserId", "PermissionId" },
                unique: true);
